    ...
    public partial class AreaEditWindow : Window
    {
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (browserDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    MessageCore.ShowWarning("The selected folder already exists");
                    return;
                }
                ...
                {
                    MessageCore.ShowWarning("This folder already exists in another area");
                    return;
                }
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageCore.ShowWarning("Area name cannot be empty");
                return;
            }
            if (IsExistsAreaName(areaName))
            {
                MessageCore.ShowWarning("Area name must be unique");
                return;
            }
            if (this.AreaFolders.Items.Count <= 0)
            {
                MessageCore.ShowWarning("At least one folder is required");
                return;
            }
            if (_areaFileTypes.Count <= 0)
            {
                MessageCore.ShowWarning("At least one supported file type is required");
                return;
            }
