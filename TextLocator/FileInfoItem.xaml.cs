...
namespace TextLocator
{
    ...
    public partial class FileInfoItem : UserControl
    {
        ...
        public void Refresh(Entity.FileInfo fileInfo)
        {
            ...
            if (fileInfo.SearchRegion == Enums.SearchRegion.FileNameAndContent || fileInfo.SearchRegion == Enums.SearchRegion.FileNameOnly)
            {
            ...
            Task.Factory.StartNew(async () => {
                ...
                _ = Dispatcher.InvokeAsync(() =>
                {
                    ...
                    if (fileInfo.SearchRegion == Enums.SearchRegion.FileNameAndContent || fileInfo.SearchRegion == Enums.SearchRegion.ContentOnly)
                    {
